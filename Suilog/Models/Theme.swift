...
extension Theme {
    ...
    static let defaultTheme = Theme(
        ...
        textColorHex: "#FFFFFF",                    // 白
        secondaryTextColorHex: "#CCFFFFFF"          // 白（80%透明度）
    )
    ...
    static let yumekawa = Theme(
        ...
        primaryColorHex: "#9B4B9B",                                   // 濃いめのマゼンタ（読みやすく）
        bubbleColorHex: "#FFFFFF",
        ...
        statisticsBackgroundColorHex: "#99FFFFFF",                    // 白（60%透明度）で読みやすく
        textColorHex: "#6B3A6B",                                      // 濃いパープル（読みやすい）
        secondaryTextColorHex: "#CC6B3A6B"                            // 濃いパープル（80%透明度）
    )
