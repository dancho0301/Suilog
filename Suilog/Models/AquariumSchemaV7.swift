//
//  AquariumSchemaV7.swift
//  Suilog
//
//  Created by dancho on 2026/02/11.
//
//  公式HPリンク対応スキーマ: officialUrlフィールドを追加

import Foundation
import SwiftData

enum AquariumSchemaV7: VersionedSchema {
    ...
    enum CheckInTypeV7: String, Codable {
        case location
        case manual
    }
    ...
    final class VisitRecord {
        ...
        var memo: String = ""
        var photoData: Data?
        var checkInType: CheckInTypeV7 = AquariumSchemaV7.CheckInTypeV7.manual
        ...
        init(
            ...
            memo: String = "",
            photoData: Data? = nil,
            checkInType: CheckInTypeV7 = .manual,
